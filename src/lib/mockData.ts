...
export const lectii = [
  ...
  ...genLectii('m18', [
    ...
    'Recapitulare Modul 3 — polish',
  ]),
  // Scratch Modul 4
  ...genLectii('m19', [
    'Start greu: motorul proiectului tău',
    'Proiect greu: Poveste cu alegeri',
    'Proiect greu: Quiz pe runde',
    'Proiect greu: Clip pe acte + control',
    'Proiect greu: Labirint pe 2 nivele',
    'Proiect liber — final greu',
    'Bug hunt greu + polish + publicare',
    'Proiect greu: Felicitare pe scene',
    'Challenge greu + prezentare / showcase',
    'Badge Scratch Creator + primul Python',
  ]),
  // Scratch Modul 5 — Lume de cuburi (stil Minecraft)
  ...genLectii('m20', [
    'Grilă + erou',
    'Sparge blocuri',
    'Pune blocuri',
